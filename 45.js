...
// решение без параметра по умолчанию
//weatherForecast = (city, weather) => `Прогноз погоды для города ${city}: ${weather == undefined ? 'Отличная погода!' : weather}`

weatherForecast = (city, weather = 'Отличная погода!') =>`Прогноз погоды для города ${city}: ${weather}`
